<?php
	...
	$sql->SQLConnection();
	$pname = "m_ter20120426105006r" ;    //"m_termicor"; //nombre de pr�ctica real actual
	...
	<div id="page">
		...
		<div id="content">
			...
			<div id="content_r">
				...
				<p>Descripci�n breve de la practica</p>
				<img src="../../../img/sist_term.jpg" />
				<p>Introduzca los par�metros del regulador PID que se desea ensayar. La estructura implementada para el regulador es de la forma suma de ganancias proporcional (Kp), integral (Ki) y derivativa (Kd). La entrada de referencia (Temperatura deseada) es igual a 5 V. (15�C).
La opci�n Simular permite ver la evoluci�n de la temperatura con el regulador ajustado sobre un modelo simulado del sistema t�rmico. La opci�n Real implementa el regulador ajustado sobre el sistema t�rmico real.
La duraci�n del ensayo con la opci�n Simular es instant�nea; con la opci�n Real es de aproximadamente 2 minutos. La ejecuci�n REAL del sistema tiene una duraci�n de 2 minutos. <?php if ($cantidad) echo "	En estos momentos hay $cantidad estacion(es) que puede(n) ejecutar de forma REAL esta pr�ctica."; ?></p>
