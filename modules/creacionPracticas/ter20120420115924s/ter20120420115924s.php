<?php
	...
	$sql->SQLConnection();
	$pname = "m_ter20120420115924r" ;    //"m_termicor"; //nombre de pr�ctica real actual
...
<body>
	<div id="page">
		...
		<div id="content">
			...
			<div id="content_r">
				<h1 class="content_r_hst1">Efecto de la acci�n integral</h1>
				...
				<form id="practice" name="practice" action="../../user/client.php" method="post" enctype="multipart/form-data">
					...
					<div class="content_r_data">
						...
						<div class="content_r_data_c">
							...
							<tr><td width='20'><span class='Estilo3'>Ki:</span></td><td width='175'><span class='Estilo3'>Acci�n Integral</span></td></tr>
							</table>
						</div>
						<div class="content_r_data_b"></div>
					</div>
