<?php
	...
	$sql->SQLConnection();
	$pname = "m_ter20120426104311r" ;    //"m_termicor"; //nombre de pr�ctica real actual
...
<body>
	<div id="page">
		...
		<div id="content">
			...
			<div id="content_r">
				<h1 class="content_r_hst1">Probando validaci�n</h1>
				<p>Descripci�n breve</p>
				<img src="../../../img/sist_term.jpg" />
				<p>Introduzca los par�metros del regulador a,b,c,d La ejecuci�n REAL del sistema tiene una duraci�n de 2 minutos. <?php if ($cantidad) echo "	En estos momentos hay $cantidad estacion(es) que puede(n) ejecutar de forma REAL esta pr�ctica."; ?></p>
