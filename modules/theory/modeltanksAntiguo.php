	...
	<div id="page">
		...
		<div id="content">
			...
			<div id="content_r">
				...
				<p>La unidad de tanques acoplados consiste en cuatro tanques interconectados como se muestra en la
					figura, y en cada uno hay un sensor de presión en el fondo que entrega un voltaje
					proporcional al nivel (0-5 volt).</p>

				<p>Un quinto tanque se encuentra en la parte inferior, en el cual hay dos bombas sumergibles que
					entregan un flujo proporcional a la acción de control que se les aplique (0-5 volt).</p>

				<p>La forma en que el agua fluye se puede configurar de muchas maneras con las vílvulas
					manuales(MVA�G, MV1�4). La configuració;n de las válvulas permite cambiar la
					dinámica y el acoplamiento, así como la generación de pasos de perturbaciones
					que da amplias posibilidades para evaluar el desempeño de numerosas estrategias de control.
				</p>
				<center><img src="../../img/couptanks.jpg" /></center>

				<h1 class="content_r_hst1"> <br />Modelo din&aacute;mico</h1>
				<p>Configurando el sistema para que quede como dos tanques en cascada (válvulas MVB, MV1 y MV2:
					abiertas, el resto cerradas), el proceso a modelar sería el siguiente:</p>
				<center><img src="../../img/tankscascada.jpg" /></center>

				<p> Donde h1(t) y h2(t) son el nivel en cada tanque [cm], u(t) el voltaje aplicado a la bomba [v], &eta;
					es la constante de proporcionalidad de la misma [cm^3/min.v], A, a1 y a2 el área de la
					sección transversal de los tanques y las tuberías respectivamente [cm^2] y g la
				...
				<p>Las ecuaciones (1) y (2) constituyen un modelo no lineal de este sistema. En ellas k1 y k2 son las
					constantes de proporcionalidad entre el flujo y la ra&iacute;z cuadrada de la presi&oacute;n que
					est&aacute; asociada al factor de fricci&oacute;n, di&aacute;metro y largo de la tuber&iacute;a, el
				...
				<p>Para determinar la funci&oacute;n de transferencia de este sistema es necesario linealizarlo
					alrededor de un punto de operaci&oacute;n. Igualando a cero las ecuaciones (1) y (2) y evaluando
					para un voltaje constante en la bomba uo, se obtienen los puntos de operaci&oacute;n h1o y h2o:</p>
				...
				<p>Poniendo en t&eacute;rminos de variaciones las ecuaciones (1) y (2) y utilizando la ecuaci&oacute;n
				...
				<p>A continuación se muestra la respuesta temporal del sistema en lazo abierto, ante una entrada
					tipo paso escalón a 3v en t=0, luego a 3.3v en t=1000s y finalmente a 2.7v en t=2000s. Todas
					las mediciones se han hecho con un periodo de muestreo de 0.1s. A partir de estas
					gráficas pueden obtenerse las ganancias estáticas K1 y K2 y las constantes de tiempo
					&tau;1 y &tau;2.</p>
				<p>Los datos correspondientes a estas curvas pueden descargarse del siguiente enlace y obtenerse con el
				...
				<p>Descargar datos de identificación.<a
						href="../../../download/downloadidentnivel.php?path=../../../download/&file=datanivel.mat"><img
							src="../../../img/download.gif" vspace="2" alt="Descargar Modelo de Simulink enviado"
							border="0" /></p>
