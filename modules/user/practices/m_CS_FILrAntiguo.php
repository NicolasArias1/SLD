			...
			<div id="content_r">
				...
				<p>A continuaci&oacute;n se muestra el esquema empleado para probar los filtros de las mediciones:</p>
					...
					<img src="../../../img/CS_FIL.jpg" />
						<p>El experimento tendr&aacute; una duraci&oacute;n de 10 segundos. Se comienza aplicando un
							voltaje de -5V al motor y a los 5 segundos de pasa a +5V. </p>
						<p>Se puede modificar el per&iacute;odo de muestreo, y el orden y frecuencia de corte de los
							...
							<div class="content_r_data">
								...
								<div class="content_r_data_c">
									...
									<table width="100%" cellpadding="0" cellspacing="0" class="form">
										<tr>
											<td>Tm:</td>
											<td><input name="Tm" type="text" class="input_field" value="0.5"
													size="15" /></td>
										</tr>
										<tr>
											<td>Nv:</td>
											<td><input name="Nv" type="text" size="15" value="1" class="input_field" />
											</td>
										</tr>
										<tr>
											<td>Fcv:</td>
											<td><input name="Fcv" type="text" size="15" value="0.1"
													class="input_field" /></td>
										</tr>
										<tr>
											<td>Np:</td>
											<td><input name="Np" type="text" size="15" value="1" class="input_field" />
											</td>
										</tr>
										<tr>
											<td>Fcp:</td>
											<td><input name="Fcp" type="text" size="15" value="0.1"
													class="input_field" /></td>
										</tr>
									</table>
									...
									<table width="100%" cellpadding="0" cellspacing="0" class="form">
										...
										<tr>
											<td class="buttons"><input type="hidden" id="mlmfile" name="mlmfile"
													value="m_CS_FILs"></td>
											<td class="buttons"><input type="button" name="Submit" value="Ejecutar"
													<?php if(($cantidad == 0) || ($timeejec > 5)||($permbytime == 0)) echo 'disabled= "disabled"';?>
													class="input_button" onClick="execute('m_CS_FILr')" /></td>
										</tr>
								...
								<div class="content_r_data_c">
									...
									<table width="100%" cellpadding="0" cellspacing="0" class="data">
										<tr>
											...
											<td width="175"><span class="Estilo3">Per&iacute;odo de muestreo (0.001
													<=Tm[s]<=1)</span> </td> </tr> <tr>
