...
$sql->SQLConnection();
$pname = "m_CS_PIDVr"; //nombre de pr&aacute;ctica real actual
								...
								<div class="content_practices">
									...
									<div class="contentp">
										<p>A continuaci&oacute;n se muestra el esquema empleado para controlar la velocidad
											...
											pasa a 50 RPM:</p>
										<img src="../../../img/CS_PIDV.jpg" class="img-fluid rounded mx-auto d-block mbotom" />
										<p>El controlador PID implementado se corresponde con el siguiente diagrama en
											bloques:</p>
										<img src="../../../img/CS_PIDV_PID.jpg" class="img-fluid rounded mx-auto d-block mbotom" />
										...
										<form id="practice" name="practice" action="../client.php" method="post" enctype="multipart/form-data">
											<div class="row" style="margin-top:30px;">
												<div class="col-sm-6 paramExp">
													...
													<div class="form-group row">
														<div class="col-sm-8">
															<input type="hidden" id="mlmfile" name="mlmfile" value="m_CS_PIDVs" class="form-control">
														</div>
													</div>

													<div class="form-group row">
														<div class="col-sm-8" style="text-align:center;">
															<input id="execute-button" type="button" name="Submit" value="Ejecutar" <?php if (($cantidad == 0) || ($timeejec > 5) || ($permbytime == 0)) echo 'disabled= "disabled"'; ?> class="input_btn1" onClick="execute('m_CS_PIDVr')" />
														</div>
													</div>
