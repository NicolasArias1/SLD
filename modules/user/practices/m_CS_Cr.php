												...
												<form id="practice" name="practice" action="../client.php" method="post" enctype="multipart/form-data">
													...
													<div class="form-group row" style="margin-top:20px;">
														<div class="col-sm-12" style="text-align:center;">
															...
															<input type="button" name="Submit" value="Ejecutar" <?php if (($cantidad == 0) || ($timeejec > 5) || ($permbytime == 0)) echo 'disabled= "disabled"'; ?> class="input_btn3" onClick="execute('m_CS_Cr')" />
														</div>
													</div>
