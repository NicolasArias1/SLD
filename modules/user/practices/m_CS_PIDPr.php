	...
	<div id="page">
		...
		<div id="content">
			...
			<div id="content_r">
				...
				<p>En este experimento se pueden modificar los par&aacute;metros antes mencionados del PID as&iacute; como el orden y frecuencia de corte del filtro (Butterworth) de posici&oacute;n.</p>
					...
					<div class="content_r_data">
						...
						<div class="content_r_data_c">
							...
							<table width="100%" cellpadding="0" cellspacing="0" class="form">
							  ...
							  <tr>
								  <td class="buttons"><input type="hidden" id="mlmfile" name="mlmfile" value="m_CS_PIDPs"></td>
							      <td class="buttons"><input type="button" name="Submit" value="Ejecutar" <?php if(($cantidad == 0) || ($timeejec > 5)||($permbytime == 0)) echo 'disabled= "disabled"';?> class="input_button" onClick="execute('m_CS_PIDPr')" /></td>
							  </tr>			  						  
