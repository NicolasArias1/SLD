						...
						<div id="content3" class="col-md-12 mt-lg-4 mt-4">
							...
							<div id="content_r">
								...
								<h1 class="content_r_hst1">Identificaci&oacute;n al paso de la din&aacute;mica de un
									motor</h1>
								<p>A continuaci&oacute;n se muestra el esquema empleado para la identificaci&oacute;n al
										...
										<form id="practice" name="practice" action="../client.php" method="post"
											...
											<div class="content_r_data">
												...
												<div class="content_r_data_c">
													<h1 class="content_r_hst3">Par&aacute;metros para el experimento:
													</h1>
													<table width="100%" cellpadding="0" cellspacing="0" class="form">
														<tr>
															<td>Tm:</td>
															<td><input name="Tm" type="text" class="input_field"
																	value="0.1" size="15" /></td>
														</tr>
														<tr>
															<td>Te:</td>
															<td><input name="Te" type="text" size="15" value="1"
																	class="input_field" /></td>
														</tr>
														<tr>
															<td>Tp:</td>
															<td><input name="Tp" type="text" size="15" value="0"
																	class="input_field" /></td>
														</tr>
														<tr>
															<td>Vi:</td>
															<td><input name="Vi" type="text" size="15" value="0"
																	class="input_field" /></td>
														</tr>
														<tr>
															<td>Vf:</td>
															<td><input name="Vf" type="text" size="15" value="1"
																	class="input_field" /></td>
														</tr>
													</table>
													...
													<table width="100%" cellpadding="0" cellspacing="0" class="form">
														...
														<tr>
															<td class="buttons"><input type="hidden" id="mlmfile"
																	name="mlmfile" value="m_CS_IDs"></td>
															<td class="buttons"><input type="button" name="Submit"
																	value="Ejecutar"
																	<?php if(($cantidad == 0) || ($timeejec > 5)||($permbytime == 0)) echo 'disabled= "disabled"';?>
																	class="input_button"
																	onClick="execute('m_CS_IDr')" /></td>
														</tr>
												...
												<div class="content_r_data_c">
													...
													<table width="100%" cellpadding="0" cellspacing="0" class="data">
														<tr>
															...
															<td width="175"><span class="Estilo3">Per&iacute;odo de
																	muestreo (0.001<=Tm[s]<=1)</span> </td> 
																
														</tr> 
														
														<tr>
															<td><span class="Estilo3">Te:</span></td>
															<td><span class="Estilo3">Tiempo de experimento (1
																	<=Te[s]<=10)</span> </td> </tr> <tr>
															<td><span class="Estilo3">Tp:</span></td>
															<td><span class="Estilo3">Instante en que ocurre el paso
																	(Tp[s]<=Te)</span> </td> </tr> <tr>
															<td><span class="Estilo3">Vi:</span></td>
															<td><span class="Estilo3">Voltaje inicial del paso
																	(+-10V)</span></td>
														</tr>
														<tr>
															<td><span class="Estilo3">Vf:</span></td>
															<td><span class="Estilo3">Voltaje final del
																	paso(+-10V)</span></td>
														</tr>
