	...
	<div id="page">
		...
		<div id="content">
			...
			<div id="content_r">
			  ...
			  <h1 class="content_r_hst2"> <strong>CARACTER&Iacute;STICAS DEL SISTEMA DE LABORATORIOS A DISTANCIA (SLD)</strong></h1>
			  ...
			  <p> El sistema presenta la siguiente arquitectura:</p>
				<p> <img src="/img/platform.png" width="562" height="358" /> </p>
