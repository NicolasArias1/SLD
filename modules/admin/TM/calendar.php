					...
					<form action='calendar.php' method='post'>
						<center>
							...
							<table>
								...
								<tr>
									<td align="center">
										<a class='ast5' href="<?php $year = $current_date[2]-1; print "$_SERVER[PHP_SELF]?date=$current_date[0]-$current_date[1]-$year"; ?>">A&ntilde;o Anterior</a>
									</td>
							    <td align="center">
								    <a class='ast5' href="<?php $month = $current_date[1]-1;	print "$_SERVER[PHP_SELF]?date=$current_date[0]-$month-$current_date[2]";	?>">Mes Anterior</a>
								  </td>
									<td align="center">
										<a class="ast5" href="<?php $month = $current_date[1]+1; print "$_SERVER[PHP_SELF]?date=$current_date[0]-$month-$current_date[2]"; ?>">Proximo Mes</a>
									</td>
									<td align="center">
										<a class="ast5" href="<?php $year = $current_date[2]+1; print "$_SERVER[PHP_SELF]?date=$current_date[0]-$current_date[1]-$year"; ?>">Proximo A&ntilde;o</a>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td colspan=4>
										<table border="0" width="100%">
											<tr>
												<td align="center"><font face=verdana><b>Reservas para: <?php print  " $current_date[0]-$date[month]-$current_date[2]"?></td>
											</tr>
										</table>
										<br>
									</td>
