                                ...
                                <div id="content_r">
                                    ...
                                    <table class="table table-bordered table-hover tsize">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row">5</th>
                                                <td><a href="../admin/theory/filtro.php "
                                                class="ast1">Implementaci&oacute;n de filtro digital</a></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">6</th>
                                                <td><a href="../admin/theory/Control.php "
