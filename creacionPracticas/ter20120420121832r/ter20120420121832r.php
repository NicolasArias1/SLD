<?php
	...
	$sql->SQLConnection();
	$pname = "m_ter20120420121832r" ;    //"m_termicor"; //nombre de práctica real actual
	...
	<div id="page">
		...
		<div id="content">
			...
			<div id="content_r">
				...
				<p>Descripción buena2.</p>
				<img src="../../img/sist_term.jpg" />
				<p>Introduzca los parámetros abcd. La ejecución REAL del sistema tiene una duración de 2 minutos. <?php if ($cantidad) echo "	En estos momentos hay $cantidad estacion(es) que puede(n) ejecutar de forma REAL esta práctica."; ?></p>
