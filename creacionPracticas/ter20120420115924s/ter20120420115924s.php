<?php
	...
	$sql->SQLConnection();
	$pname = "m_ter20120420115924r" ;    //"m_termicor"; //nombre de práctica real actual
...
<body>
	<div id="page">
		...
		<div id="content">
			...
			<div id="content_r">
				<h1 class="content_r_hst1">Efecto de la acción integral</h1>
				...
				<form id="practice" name="practice" action="../../user/client.php" method="post" enctype="multipart/form-data">
					<div class="content_r_data">
						...
						<div class="content_r_data_c">
							...
							<table width="100%" cellpadding="0" cellspacing="0" class="form">
							 <tr><td>Ki</td><td><input name='Ki' type='text' class='input_field' value='0.7' size='15' /></td></tr>
							</table>							
							
							<table width="100%" cellpadding="0" cellspacing="0" class="form">
							  
							  <tr>
								  <td class="buttons"><input type="hidden" id="mlmfile" name="mlmfile" value="m_ter20120420115924s"></td>
							    <td class="buttons"><input type="button" name="Submit" value="Simular" class="input_button" onClick="execute('m_ter20120420115924s')" /></td>
							  </tr>
							</table>
						</div>
					...
					<div class="content_r_data">
						...
						<div class="content_r_data_c">
							...
							<tr><td width='20'><span class='Estilo3'>Ki:</span></td><td width='175'><span class='Estilo3'>Acción Integral</span></td></tr>
							</table>
						</div>
						<div class="content_r_data_b"></div>
					</div>
