<?php
	...
	$sql->SQLConnection();
	$pname = "m_ter20120423131148r" ;    //"m_termicor"; //nombre de práctica real actual
...
<body>
	<div id="page">
		...
		<div id="content">
			...
			<div id="content_r">
				<h1 class="content_r_hst1">Doble2</h1>
				<p>Descripción breve de la practica 2</p>
					...
					<div class="content_r_data">
						...
						<div class="content_r_data_c">
							...
							<table width="100%" cellpadding="0" cellspacing="0" class="form">
							 <tr><td>a</td><td><input name='a' type='text' class='input_field' value='3' size='15' /></td></tr> <tr><td>b</td><td><input name='b' type='text' class='input_field' value='3' size='15' /></td></tr> <tr><td>c</td><td><input name='c' type='text' class='input_field' value='4' size='15' /></td></tr> <tr><td>d</td><td><input name='d' type='text' class='input_field' value='4' size='15' /></td></tr>
							</table>							
							
							<table width="100%" cellpadding="0" cellspacing="0" class="form">
							  
							  <tr>
								  <td class="buttons"><input type="hidden" id="mlmfile" name="mlmfile" value="m_ter20120423131148s"></td>
							    <td class="buttons"><input type="button" name="Submit" value="Simular" class="input_button" onClick="execute('m_ter20120423131148s')" /></td>
							  </tr>
							</table>
						</div>
