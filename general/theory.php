                               ...
                               <div id="content_r" style="width:500px;">
                                ...
                                <table style="font-size:14px;" class="table table-bordered table-hover tsize">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row">1</th>
                                                <td><a style="text-decoration:none;" href="../modules/theory/modeltanks.php"
                                                class="ast1">Modelado del sistema de tanques acoplados</a></td>
                                                
                                            </tr>
                                            <tr>
                                                <th scope="row">2</th>
                                                <td><a style="text-decoration:none;" href="../modules/theory/motorcd.php "
                                                class="ast1">Modelado de un motor de corriente directa</a></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">3</th>
                                                <td><a style="text-decoration:none;" href="../modules/theory/modeloport.php "
                                                class="ast1">Identificaci&oacute;n de Sistemas por modelo PORT</a></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">4</th>
                                            ...
                                            <tr>
                                                <th scope="row">5</th>
                                                <td><a style="text-decoration:none;" href="../modules/theory/filtro.php "
                                                class="ast1">Implementaci&oacute;n de filtro digital</a></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">6</th>
                                                <td><a style="text-decoration:none;" href="../modules/theory/Control.php "
                                                class="ast1">Implementaci&oacute;n de controlador digital</a></td>
                                            </tr>
                                        </tbody>
