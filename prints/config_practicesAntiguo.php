							...
							<?php
							 	if($this->results[$i]['sid'] == '1' || $this->results[$i]['id'] == $this->pid) {
									...
									<a style="text-decoration:none;"
										href="configp.php?body=edit&rbody=<?php echo $this->body; ?>&order=<?php echo $this->order[0]; ?>&show=<?php echo $this->show; ?>&page=<?php echo $this->page; ?>&id=<?php echo $this->results[$i]['id']; ?>" onclick="selectResource(<?php echo ($i+1); ?>)"><img src="../../img/edit.gif" alt="Editar" width="15" height="16" vspace="2" border="0" />
									...
									<td width="20px" class="image">
									<a style="text-decoration:none;"
										href="javascript:deleteUsers(<?php echo $this->results[$i]['pcname']; ?>, 1, '<?php echo $this->body; ?>', '<?php echo $this->order[0]; ?>', <?php echo $this->show; ?>, <?php echo $this->page; ?>)" onclick="selectResource(<?php echo ($i+1); ?>)"><img src="../../img/del.gif" alt="Eliminar" vspace="2" border="0" />
