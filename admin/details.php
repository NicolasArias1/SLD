	...
	<div id="page">
		...
		<div id="content">
			...
			if($vote && VOT_CONT) {
				...
				<div id="vote_box">
					<p class="header">Calificaci&oacute;n</p>
						<form id="vote_form" name="vote_form" method="post" action="../modules/updatecontribution.mod.php" enctype="multipart/form-data">
				...
				if(COM_CONT) {
					...
					<div id="comment_form_box">
						...
						<form id="comment_form" name="comment_form" method="post" action="../modules/updatecontribution.mod.php" enctype="multipart/form-data">
		    ...
		    <div id="comment_form_box">
			       ...
			       <form id="rev_form" name="rev_form" method="post" action="../modules/updatepracticesrev.mod.php" enctype="multipart/form-data">
