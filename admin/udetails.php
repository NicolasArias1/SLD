<?php
	...
	include('../modules/udetails.mod.php');
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="JavaScript" src="../js/cronos.js" type="text/javascript"></script>
		<script language="JavaScript" src="../js/ucronos.js" type="text/javascript"></script>
	</head>
