		...
		<div id="content">
			...
			<div id="content_r">
				...
				<form id="frmuser" name="frmuser" method="post" action="" enctype="multipart/form-data">
					<div class="user_celd">
						<p class="user_field"><img src="../../img/uarrow.gif" alt="Obligatorio" /> Dispositivo real para el que realizar&aacute; la pr&aacute;ctica:</p>
						<select name="select">
					...
					<div class="user_celd">
						<p class="user_field"><img src="../../img/uarrow.gif" alt="Obligatorio" /> Tipo de pr&aacute;ctica a realizar:</p>
						<p>
					    <label>
					    <input type="radio" name="Tipo de practica" value="opci&oacute;n">Param&eacute;trica</label>
					    <br>
					    <label>
					    <input type="radio" name="Tipo de practica" value="opci&oacute;n">Con cambio de estrategia</label>
					  </p>
					</div>
					<div class="user_celd">
						<p class="user_field"><img src="../../img/uarrow.gif" alt="Obligatorio" /> Nombre de la pr&aacute;ctica:</p><input id="name" name="name" type="text" class="form_field" size="25" maxlength="200" autocomplete="off" />
					</div>
