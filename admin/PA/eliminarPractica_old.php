...
function eliminarPractica($valor){
   ...
   $directorioAeliminar = substr($valor, 2); // Corto el m_ al nombre de la práctica
   ...
   $query="DELETE FROM sld_practices_data_2 WHERE pname = '$valor'";
	...
	borrarPracticaDelServidor($directorioAeliminar,substr($real, 2));
...
function borrarPracticaDelServidor($valor,$real){
	...
	$resultado    = str_replace (";m_".$valor, "", $practicasServidor);
