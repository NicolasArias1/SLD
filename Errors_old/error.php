<?php
  ...
  switch ($varerror) {
    ...
    case 1:
        $out = "ERROR: Hay variables fuera de rango.";
        break;
    case 2:
        $out = "ERROR: Las variables no se han introducido correctamente.";
        break;
    case 3:
        $out = "ERROR: No se mandó ningún modelo para ejecutar";
        break;
    case 4:
        $out = "ERROR: Error en el modelo introducido";
        break; 
    case 5:
        $out = "F@".$varerror;
        break;        
