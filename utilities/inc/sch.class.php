...
class Search {
	...
	function showResults() {
		...
		ob_start();
		if($this->user)			
			include('../../prints/user_search_results.php');
		else
			include('prints/search_results.php');
	...
	function showDirectory() {
		...
		ob_start();
		include('../../prints/user_mydirectory.php');
...
function schPconfig($pid) {
	...
	function showUsers() {
		...
		if($this->body == 'directories') {
			...
			include('../../prints/administrator_directories.php');
		}//end if
		else
...
function showConfigp() {
	...
	function showContacts() {
		...
		ob_start();
		include('../../prints/administrator_contacts.php');
		$usrHTML = ob_get_contents();
		ob_end_clean();
	...
	function showULogs() {
		...
		ob_start();
		include('../../prints/administrator_logs.php');
		$usrHTML = ob_get_contents();
		ob_end_clean();
	...
	function showContributions() {
		...
		if($this->body == "resources" || $this->body == "commented" || $this->body == "valued")
			include('../../prints/contribution_resources.php');
		else if($this->body == "suggestions")
			include('../../prints/contribution_suggestions.php');
		$schHTML = ob_get_contents();
		ob_end_clean();
