...
class soap_transport_http extends nusoap_base {
	...
	* @access   private
	*/
	function connect($connection_timeout=600,$response_timeout=600){
...
//		}
	...
	* @access   public
	*/
	function send($data, $timeout=600, $response_timeout=600, $cookies=NULL) {
	...
	* @deprecated
	*/
	function sendHTTPS($data, $timeout=600, $response_timeout=600, $cookies) {
...
class wsdl extends nusoap_base {
     ...
     * @access public 
     */
    function wsdl($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=600,$response_timeout=600,$curl_options=null,$use_curl=false){
		parent::nusoap_base();
...
class nusoap_client extends nusoap_base  {
	...
	var $timeout = 600;				// HTTP connection timeout
	...
	* @access   private
	*/
	function send($msg, $soapaction = '', $timeout=600, $response_timeout=600) {
		$this->checkCookies();
		// detect transport
		switch(true){
			// http(s)
