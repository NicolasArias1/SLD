	...
	<div id="page">
		...
		<div id="content">
			...
			<div id="content_r">
				...
				<h1 class="content_r_hst1">En colaboraci&oacute;n con UPM (DISAM)<br /><span class="content_r_sst1">(Departamento de Autom&aacute;tica, Ingenier&iacute;a Electr&oacute;nica e Inform&aacute;tica Industrial</a>)</span></h1>
				...
				<p style=" text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 0px;">
					<img width=100 height=100 alt="" hspace=1 vspace=1 src="img/u_logos.jpg">
				</p>
			</div>
			<div class="blank"></div>
		</div>
